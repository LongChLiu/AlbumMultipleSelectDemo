//
//  LcPreviewCollectionViewCell.swift
...
class LcPreviewCollectionViewCell: UICollectionViewCell,UIScrollViewDelegate {
    ...
    var photoImage: UIImage? {
        didSet {
            ...
            let frame = CGRect(x: 0, y: 0, width: kScreenWidth, height: imageHeight)
